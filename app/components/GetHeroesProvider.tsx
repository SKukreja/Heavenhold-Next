...
export function HeroesProvider({ children }: React.PropsWithChildren<{}>) {
  ...
  return (
    <HeroesContext.Provider  value={{ data }}>
      <div className="fixed z-0 w-full lg:left-[30%] lg:w-[calc(100vw-30%)] h-[calc(100vh)] pointer-events-none after:pointer-events-none bg-cover bg-no-repeat bg-center after:bg-black after:bg-[radial-gradient(rgba(255,255,255,0.1)_1px,transparent_1px)] after:[background-size:12px_12px] after:opacity-90 after:absolute after:inset-0 after:z-10" style={{
