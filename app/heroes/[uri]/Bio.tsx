    ...
    <div id="Bio" className="relative overflow-visible z-10 w-full h-[calc(100vh-12rem)] items-start flex px-4 3xl:px-8">
      <div className="px-4 3xl:px-8 w-1/4 flex-col justify-start h-[calc(100%-8rem)] flex">
        ...
        <div className="pt-16 flex flex-col gap-4 3xl:gap-6 justify-between w-full text-xs 3xl:text-sm">
          ...
          <div className="w-full">
            <span className="w-1/2 inline-block font-bold">Equipment</span><span className="w-1/2 inline-flex items-center justify-end text-right">
        ...
        <div className="pt-16 block relative tracking-wider">
            ...
            <div className="mb-2 relative h-8 bg-gray-1100">
                <div className="bg-red-600 h-8 rounded-sm progress-bar text-xs" style={{ width: `${Math.max((1 - hero.heroInformation.statFields.atkRank / (hero.heroInformation.statFields.heroCount ?? 1)) * 100, 10)}%` }}></div>
      ...
      <div className="w-1/4 h-full px-8">
        ...
        <div className="w-full h-[calc(100%-32rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-800 scrollbar-track-gray-1100">
          <span className="w-full h-full overflow-y-scroll text-xs 3xl:text-sm" dangerouslySetInnerHTML={{ __html: hero.heroInformation.bioFields.story }}></span>
        </div>
      </div>
    </div>
  );
