...
export type RootQuery = {
  ...
  /** Get teams and their total vote and downvote counts for a specific user */
  teamsVotesWithUserVote: Maybe<Array<Maybe<TeamVoteCount>>>;
...
/** The root entry point into the Graph */
export type RootQueryTeamsVotesWithUserVoteArgs = {
  ipAddress?: InputMaybe<Scalars['String']['input']>;
  userId?: InputMaybe<Scalars['Int']['input']>;
};
...
export type TeamUserVote = {
  __typename?: 'TeamUserVote';
  /** The team ID */
  teamId: Maybe<Scalars['Int']['output']>;
...
/** Team ID, Vote Count, Downvote Count */
export type TeamVoteInfo = {
  __typename?: 'TeamVoteInfo';
  /** The total number of downvotes */
  downvoteCount: Maybe<Scalars['Int']['output']>;
  /** The team ID */
  teamId: Maybe<Scalars['Int']['output']>;
...
export type GetGuidesQuery = { __typename?: 'RootQuery', guides: { __typename?: 'RootQueryToGuideConnection', pageInfo: { __typename?: 'RootQueryToGuideConnectionPageInfo', endCursor: string | null, hasNextPage: boolean }, nodes: Array<{ __typename?: 'Guide', databaseId: number, title: string | null, slug: string | null, content: string | null, date: string | null, featuredImage: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', mediaItemUrl: string | null, sourceUrl: string | null } } | null }> } | null };
...
export type GetUserTeamVoteStatusQuery = { __typename?: 'RootQuery', getUserTeamVoteStatus: Array<{ __typename?: 'TeamUserVote', teamId: number | null, userVote: string | null } | null> | null };
...
export const DownvoteTeamDocument = gql`
    mutation DownvoteTeam($teamId: Int!, $userId: Int!, $ipAddress: String!) {
  downvoteTeam(input: {teamId: $teamId, userId: $userId, ipAddress: $ipAddress}) {
    teamId
    success
    currentVote
  }
...
export const UpvoteTeamDocument = gql`
    mutation UpvoteTeam($teamId: Int!, $userId: Int!, $ipAddress: String!) {
  upvoteTeam(input: {teamId: $teamId, userId: $userId, ipAddress: $ipAddress}) {
    teamId
    success
    currentVote
  }
...
/**
 * __useGetMetaVotesQuery__
 *
 * To run a query within a React component, call `useGetMetaVotesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMetaVotesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMetaVotesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetMetaVotesQuery(baseOptions?: Apollo.QueryHookOptions<GetMetaVotesQuery, GetMetaVotesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMetaVotesQuery, GetMetaVotesQueryVariables>(GetMetaVotesDocument, options);
      }
export function useGetMetaVotesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMetaVotesQuery, GetMetaVotesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMetaVotesQuery, GetMetaVotesQueryVariables>(GetMetaVotesDocument, options);
        }
export function useGetMetaVotesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetMetaVotesQuery, GetMetaVotesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetMetaVotesQuery, GetMetaVotesQueryVariables>(GetMetaVotesDocument, options);
        }
export type GetMetaVotesQueryHookResult = ReturnType<typeof useGetMetaVotesQuery>;
...
/**
 * __useGetTeamVotesQuery__
 *
 * To run a query within a React component, call `useGetTeamVotesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetTeamVotesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetTeamVotesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetTeamVotesQuery(baseOptions?: Apollo.QueryHookOptions<GetTeamVotesQuery, GetTeamVotesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetTeamVotesQuery, GetTeamVotesQueryVariables>(GetTeamVotesDocument, options);
      }
export function useGetTeamVotesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetTeamVotesQuery, GetTeamVotesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetTeamVotesQuery, GetTeamVotesQueryVariables>(GetTeamVotesDocument, options);
        }
export function useGetTeamVotesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetTeamVotesQuery, GetTeamVotesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetTeamVotesQuery, GetTeamVotesQueryVariables>(GetTeamVotesDocument, options);
        }
export type GetTeamVotesQueryHookResult = ReturnType<typeof useGetTeamVotesQuery>;
...
/**
 * __useGetUserTeamVoteStatusQuery__
 *
 * To run a query within a React component, call `useGetUserTeamVoteStatusQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUserTeamVoteStatusQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUserTeamVoteStatusQuery({
 *   variables: {
 *      userId: // value for 'userId'
 *      ipAddress: // value for 'ipAddress'
 *   },
 * });
 */
export function useGetUserTeamVoteStatusQuery(baseOptions: Apollo.QueryHookOptions<GetUserTeamVoteStatusQuery, GetUserTeamVoteStatusQueryVariables> & ({ variables: GetUserTeamVoteStatusQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUserTeamVoteStatusQuery, GetUserTeamVoteStatusQueryVariables>(GetUserTeamVoteStatusDocument, options);
      }
export function useGetUserTeamVoteStatusLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUserTeamVoteStatusQuery, GetUserTeamVoteStatusQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUserTeamVoteStatusQuery, GetUserTeamVoteStatusQueryVariables>(GetUserTeamVoteStatusDocument, options);
        }
export function useGetUserTeamVoteStatusSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetUserTeamVoteStatusQuery, GetUserTeamVoteStatusQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetUserTeamVoteStatusQuery, GetUserTeamVoteStatusQueryVariables>(GetUserTeamVoteStatusDocument, options);
        }
export type GetUserTeamVoteStatusQueryHookResult = ReturnType<typeof useGetUserTeamVoteStatusQuery>;
export type GetUserTeamVoteStatusLazyQueryHookResult = ReturnType<typeof useGetUserTeamVoteStatusLazyQuery>;
export type GetUserTeamVoteStatusSuspenseQueryHookResult = ReturnType<typeof useGetUserTeamVoteStatusSuspenseQuery>;
export type GetUserTeamVoteStatusQueryResult = Apollo.QueryResult<GetUserTeamVoteStatusQuery, GetUserTeamVoteStatusQueryVariables>;